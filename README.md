...
directly, because the gallery and publications load from JSON.

## Edit

- `index.html`: biography, navigation, and profile links.
- `css/style.css`: responsive layout and light/dark themes.
- `data/content.json`: publications and gallery entries.
- `assets/gallery/`: compressed videos and their JPEG posters.
...
Aim for less than 5 MB per clip. Gallery videos load only when opened.
